import{_ as s,c as a,o as n,a4 as i}from"./chunks/framework.C3OGjX9z.js";const o=JSON.parse('{"title":"配置文件","description":"","frontmatter":{},"headers":[],"relativePath":"zh_cn/advanced/config.md","filePath":"zh_cn/advanced/config.md","lastUpdated":1722006316000}'),p={name:"zh_cn/advanced/config.md"},e=i(`<h1 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h1><div class="note custom-block github-alert"><p class="custom-block-title">默认的配置目录为 ./conf</p><p></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>.</span></span>
